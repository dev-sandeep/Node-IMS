...
exports.create = function (req, response) {
    ...
    var myobj = {
        name: req.body.name,
        address: req.body.address,//mail id or any unique identity
    ...
    crud.create(global.data.table.shop, myobj, myObjFilter).then(function (successData) {
...
/*************************************************************************/
/**
 * responsible for updating the shop
 */
exports.edit = function (req, response) {
    ...
    crud.update(global.data.table.shop, myobj, myObjFilter, payloadObj).then(function (successData) {
...
exports.get = function (req, response) {
    ...
    crud.get(global.data.table.shop, requiredField, query, page, resultperpage).then(function (successData) {
        /* every thing is awesome */console.log("awesoem");
        response.send(successData);
    }).catch(function (errorData) {
        /* all is not well */console.log("not awesoem");
...
exports.detail = function (req, response) {
    ...
    crud.get(global.data.table.shop, requiredField, query).then(function (successData) {
        /* every thing is awesome */console.log("awesoem");
        response.send(successData);
    }).catch(function (errorData) {
        /* all is not well */console.log("not awesoem");
...
////////////////////////END/////////////////////////////
////////////////////////////////////////////////////////
exports.delete_optional = function (req, response) {
    var crud = require('./../util/crud.js');
    /* now call the generic methods to edit */
    var myObj = {
        id: req.body.id
    }
    crud.delete(global.data.table.shop, myObj).then(function (successData) {
         /* every thing is awesome */console.log("status updated");
        response.send(successData);
    }, function (errorData) {
        /* all is not well */console.log("status not updated");
